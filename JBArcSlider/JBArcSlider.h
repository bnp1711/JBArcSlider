...
/**
 *  Class used to define a arc control with a handle that can be moved around the circumference to represent a value
 */
@interface JBArcSlider : UIControl

typedef enum : NSUInteger {
    ArcSliderHandleTypeSemiTransparentWhiteArc,
    ArcSliderHandleTypeSemiTransparentBlackArc,
    ArcSliderHandleTypeDoubleArcWithOpenCenter,
    ArcSliderHandleTypeDoubleArcWithClosedCenter,
    ArcSliderHandleTypeBigCircle
} ArcSliderHandleType;
 ...
 *
 *  @param radius Desired radius of arc slider
 *
 ...
 *
 *  @property NSArray of strings used to render labels at regular intervals within the Arc
 */
...
/**
 *  @property Font of the inner marking labels within the Arc
 */
@property (nonatomic, strong) UIFont*  labelFont;
/**
 *  @property Color of the inner marking labels within the Arc
 */
 ...
 */
@property (nonatomic) ArcSliderHandleType handleType;
